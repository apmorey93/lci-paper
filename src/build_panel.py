...
rows = [
    # --- comparable instruct panel (Llama-3 -> Llama-3.1), one protocol per metric ---
    dict(family="QA", benchmark="MMLU", date="2024-04-01", model="Llama-3-70B-Instruct",
         variant="instruct", protocol="5-shot, no CoT, macro-avg acc", score_pct=83.6, n=14042,
    ...
    dict(family="Code", benchmark="HumanEval", date="2024-04-01", model="Llama-3-70B-Instruct",
         variant="instruct", protocol="0-shot pass@1 (Meta internal evals)", score_pct=80.5, n=164,
    ...
    dict(family="Code", benchmark="HumanEval", date="2024-07-01", model="Llama-3.1-70B-Instruct",
         ...
         url="https://huggingface.co/meta-llama/Llama-3.1-70B-Instruct", confidence=0.70),
